...
Report bugs to the issues section or direct message me via discord @ ecoholisti
...
# Download
To install this,download the exe file at the very top, once downloaded, extract the files into a folder on your desktop and run RBX-multi-account-tool.exe
